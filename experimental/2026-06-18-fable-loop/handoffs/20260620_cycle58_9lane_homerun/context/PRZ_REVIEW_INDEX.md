...
This folder is a public experimental deposit of the Codex/Opus 4.8 RS-MCA loop through Cycles 49-57. It does not claim a prize-level solve. It preserves raw artifacts, prompts, audits, and local checks for the upper-side MCA route after the Cycle 45-47 lower/failure branch work.
...
Raw `response.md`, `raw_response.jsonl`, manifests, and run results live under `raw/`. They are provenance, not paper-ready claims.
...
experimental/2026-06-18-fable-loop/prompts/
experimental/2026-06-18-fable-loop/raw/
...
4. Use raw artifacts only to verify audit provenance.
